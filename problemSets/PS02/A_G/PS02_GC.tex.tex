...
%		\includegraphics[width=1.1\textwidth]{../../../graphics/women_desc.png}
	...
	\begin{enumerate}
		...
		Import the data set and obtain summary statistiscs and examine the distribution of the overall lifespan of the fruitflies. 
		 \lstinputlisting[language=R, firstline=1, lastline=2]{PS02_GC.R}
		\begin{verbatim}
		> describe(fruitfly)
		vars   n  mean    sd median trimmed   mad
		thorax       1 124  0.82  0.08   0.84    0.83  0.06
		longevity    2 124 57.62 17.52  58.00   57.68 17.79
		activity*    3 124  2.99  1.42   3.00    2.99  1.48
		min   max range  skew kurtosis   se
		thorax     0.64  0.94   0.3 -0.61    -0.47 0.01
		longevity 16.00 97.00  81.0 -0.03    -0.46 1.57
		activity*  1.00  5.00   4.0  0.01    -1.33 0.13
	\end{verbatim}
 hist(fruitfly$lifespan)
		...
		\item
		>
		\begin{verbatim} plot(lifespan$x2, thorax$y2)
		Error in plot(lifespan$x2, thorax$y2) : object 'lifespan' not found
		> abline(lm(lifespan$y2 ~ thorax$x2), col = "blue")
		Error in eval(predvars, data, env) : object 'lifespan' not found
		
		\begin{verbatim}
		> plot(lifespanx, thoraxy)
		\begin{figure}
			\centering
